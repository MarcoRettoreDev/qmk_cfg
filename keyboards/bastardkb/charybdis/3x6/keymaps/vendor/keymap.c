...
// clang-format off
/** \brief QWERTY layout (3 rows, 12 columns). */
...
#define LAYOUT_LAYER_NUMERAL                                                                  \
    ...
    XXXXXXX,  KC_SCLN,    KC_4,    KC_5,    KC_6,  KC_EQL, ______________HOME_ROW_GACS_R______________, \
...
#define LAYOUT_LAYER_SYMBOLS                                                                  \
    ...
    XXXXXXX,  KC_COLN,  KC_DLR, KC_PERC, KC_CIRC, KC_PLUS, ______________HOME_ROW_GACS_R______________, \
